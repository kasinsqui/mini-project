...
public class Validacao {
    ...
    public static boolean validarTelefoneBoolean(JFormattedTextField campo) {
        int tamanho = campo.getText().replaceAll(" ", "").length();
    ...
    public static boolean vazio(String s) {
        s = Formatacao.removerFormatacao(s);
    ...
    public static boolean temNumeros(String s) {
        return s.matches(".*\\d+.*");
    }

    public static boolean temLetras(String s) {
